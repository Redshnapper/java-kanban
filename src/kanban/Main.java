...
public class Main {
    public static void main(String[] args) {
        ...
        LocalDateTime date = LocalDateTime.of(2023, 9, 7, 20, 0);
        LocalDateTime date2 = LocalDateTime.of(2023, 9, 7, 15, 0);
        LocalDateTime date3 = LocalDateTime.of(2023, 9, 7, 10, 0);
        Task withTimeTask = new Task("Task", "Task with time", TaskStatuses.NEW, date, 60);
        Task withTimeTask2 = new Task("Task 2", "Task with time 2", TaskStatuses.NEW, date2, 299);
        Task withTimeTask3 = new Task("Task 3", "Task with time 3", TaskStatuses.NEW, date3, 299);
...
//        tasksManager.printPrioritizedTasks();
...
//        tasksManager.getEpicById(epicId2); // 4
//        tasksManager.getTaskById(taskId2); // 2
//        tasksManager.getTaskById(taskId1); // 1
//        tasksManager.getEpicById(epicId1); // 3
//        tasksManager.getEpicById(epicId2); // 4
